...
import { faMobile, faMailBulk, faGears } from "@fortawesome/free-solid-svg-icons";
    ...
    <React.Fragment>
      ...
      {!profile.mobileNumber && (
        <div className="container text-center">
          <h2>Sorry! Its look like you did not have filled your complete Details</h2>
          ...
          <div className="container">
            <FontAwesomeIcon icon={faGears} style={{marginTop:'15vh',height:'40vh',opacity:'0.4'}}/>
          </div>
        </div>
      )}
    </React.Fragment>
